...
@SpringBootTest(properties = "onlinejudge.test.legacy-header-auth=false")
...
class BackendOfflineJwtAuthenticationTest {
    ...
    static void identityJwks(DynamicPropertyRegistry registry) {
        registry.add("onlinejudge.identity.jwks", BackendOfflineJwtAuthenticationTest::jwks);
    }
    ...
    @Test
    void cachedJwksAuthorizesAnExistingSessionWithoutCallingIdentity() throws Exception {
