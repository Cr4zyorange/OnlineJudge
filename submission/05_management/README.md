...
这里是 Issue #369 的管理证据入口。只固化已经发生、可回查的事实；未取得的原件、确认或访问验证一律标为 BLOCKED，不以计划、普通评论或 Owner 登录态替代。

- [INDEX](INDEX.md)：平台、材料、哈希和结论入口。
...
开发期协作正本为 [GitHub 协作与评审规范](../../docs/过程/项目管理/GitHub协作与评审规范.md) 和 [每日站会与汇报工作规范](../../docs/过程/项目管理/每日站会与汇报工作规范.md)。Notion 页面是受权限控制的原始来源；本目录不复制访问令牌、临时签名 URL、成员私人信息或截图中的无关隐私。
