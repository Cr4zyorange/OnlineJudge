...
@Sql(
        statements = {
                ...
                "DELETE FROM t_identity_outbox_event",
...
class AuthSubjectSecurityTest {
    ...
    @Test
    void logoutAdvancesSecurityVersionAndRevokesAllPreviouslyIssuedTokens() throws Exception {
        ...
        assertThat(jdbcTemplate.queryForObject(
                "SELECT security_version FROM t_auth_user WHERE username = ?", Long.class, "parallel-user"))
                .isEqualTo(2L);
        assertThat(jdbcTemplate.queryForObject(
                "SELECT event_type FROM t_identity_outbox_event", String.class))
                .isEqualTo("identity.security-version.changed.v2");
        assertThat(jdbcTemplate.queryForObject(
                "SELECT delivery_status FROM t_identity_outbox_event", String.class))
                .isEqualTo("PENDING");
    }
