...
public class AssessmentIdentityProperties {
    ...
    private String serviceAudience = "assessment";
    ...
    public String getServiceAudience() { return serviceAudience; } public void setServiceAudience(String v) { serviceAudience = v; }
