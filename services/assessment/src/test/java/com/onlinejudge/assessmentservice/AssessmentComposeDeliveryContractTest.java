...
class AssessmentComposeDeliveryContractTest {
    ...
    void apiAndWorkerMountTheSameNonRootSubmissionVolume() throws Exception {
        ...
        assertThat(compose).contains("assessment-sandbox-docker-proxy:", "assessment-sandbox-image-init:");
        ...
        assertThat(worker).contains("assessment-sandbox-docker-proxy: {condition: service_started}", "assessment-sandbox-image-init: {condition: service_completed_successfully}")
        ...
        assertThat(compose).contains("ASSESSMENT_COURSE_AUTHORIZATION_URI: ${ASSESSMENT_COURSE_AUTHORIZATION_URI:?ASSESSMENT_COURSE_AUTHORIZATION_URI is required}");
        assertThat(compose).contains("ASSESSMENT_COURSE_SERVICE_AUTHORIZATION: ${ASSESSMENT_COURSE_SERVICE_AUTHORIZATION:?ASSESSMENT_COURSE_SERVICE_AUTHORIZATION is required}");
