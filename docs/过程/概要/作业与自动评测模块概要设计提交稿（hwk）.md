...
| ------- | ---------- | ----- | ------------------------------------------ | -------------------------- | ---------------------------------------------------------------------------------------------------- |
| HWK-P01 | 作业中心页      | 学生、教师 | 学生查看待完成、已提交、已截止作业；教师查看自己发布或草稿状态的作业。        | FR-HWK-01、FR-HWK-02、FR-HWK-06 | `GET /api/v1/homeworks`                                                                              |
...
| --------------------- | ------------- | ----------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | --------- |
| FR-HWK-01              | 3.1 作业创建与发布   | HWK-P02、HWK-P03         | `POST /homeworks`、`PUT /homeworks/{id}`、`PUT /homeworks/{id}/publish`                                    | `t_homework`、`t_homework_question`、`t_homework_test_case`            | TC-HWK-01  |
...
| NFR-HWK-01 ~ NFR-HWK-05 | 第 4 节非功能需求设计  | 全部 HWK 页面               | 全部 HWK 接口                                                                                                | 全部 HWK 表                                                             | TC-HWK-NFR |
