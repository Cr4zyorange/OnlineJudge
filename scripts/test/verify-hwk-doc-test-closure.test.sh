...
require_text "$closure" '修复 Issue #296'
require_text "$closure" '负责人 @terrana37，计划开始 2026-08-29，目标完成 2026-09-05'
require_text "$closure" 'Issue #264 结论：文档与测试闭环交付完成，可按 Issue #264 关闭；FR-HWK-04 的 CODE 后台 Worker 产品验收仍为 FAIL，修复由 #296 独立跟踪。'
...
require_text "$test_document" '| 报告版本 | V1.8 |'
require_text "$test_document" '| 编写日期 | 2026-08-27 |'
require_text "$test_document" '| 最终结论 | #264 文档/测试闭环完成 |'
require_text "$test_document" 'FR-HWK-04 的产品验收仍为 FAIL，由 Issue #296 独立修复'
