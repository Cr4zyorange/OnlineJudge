...
tstdoc='docs/过程/测试/TST-DOC-06 HWK 作业与自动评测测试文档.md'
...
require_file "$tstdoc"
require_text "$closure" 'HWK 共享 E2E（Playwright runner） | 2 | 2'
require_text "$closure" 'HWK 共享 E2E（FR-HWK-04 产品判定） | 1 | 0 | 1'
require_text "$closure" '由修复 Issue #296 独立跟踪至终态'
require_text "$tstdoc" '| V1.9 | 2026-08-27'
require_text "$tstdoc" '由修复 Issue #296 独立跟踪至终态'
reject_text "$closure" '业务验收 | 2 | 1 | 1'
reject_text "$closure" '#264 关闭前须完成'
reject_text "$tstdoc" '2/2 通过；复用'
reject_text "$tstdoc" '| V1.7 | 2026-08-27'
