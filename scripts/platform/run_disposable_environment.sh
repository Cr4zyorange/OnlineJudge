...
usage() {
  cat <<'USAGE'
Usage: scripts/platform/run_disposable_environment.sh [--git-sha SHA] [--output-dir DIR] [--keep] [--keep-runtime-env] [--runtime-env-path FILE] [--skip-build] [--skip-tests] [--inject-failure migration|readiness]
